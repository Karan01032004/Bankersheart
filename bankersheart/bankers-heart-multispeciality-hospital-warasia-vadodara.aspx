        ...
        <div class="container">
            <div class="row">
                <div class="banner-heading">
                    <h1 class="text-white text-center mb-0 h2">Bankers Heart and Multi Specialty Hospital, Warasia - Vadodara</h1>
                </div>
            </div>
        </div>
    </section>
            ...
            <section id="hospital-details" class="py-5">
                <div class="container py-lg-4">
                    <div class="blog-container text-lg-start text-center pt-lg-3">
                        <%--   <h2 class="clr-black fw-bold d-lg-none d-block">Bankers Heart and Multi Specialty Hospital, Warasia</h2>--%>
            ...
            <div class="row pb-5">
                ...
                <div class="col-lg-6 contact-details px-0 mt-lg-0 mt-5">
                    ...
                    <div class="text-center mt-3 mb-2">
                        <strong>Warasia – Vadodara Bankers Heart and Multi Specialty Hospital</strong>
                    </div>
                    <div class="row pt-3 align-items-center px-sm-0 px-2">
                        <div class="col-2 text-center">
                            <picture>
                                ...
                                <img class="img-fluid" src="https://www.bankersheart.com/assets/img/red-location-icon.svg" alt="DIALYSIS">
                            </picture>
                        </div>
                    ...
                    <div class="row pt-3 align-items-center px-sm-0 px-2">
                        <div class="col-2 text-center">
                            <picture>
                                ...
                                <img class="img-fluid" src="https://www.bankersheart.com/assets/img/red-call-icon.svg" alt="bankers call">
                            </picture>
                        </div>
                        <div class="col-10 ps-0">
                            <a href="tel:+91 265 2530000">+91 265 2530000</a><br class="d-md-none d-inline-block" />
                            <a href="tel:+91 265 2530530" class="ps-md-3">+91 265 2530530</a><br />
                            <a href="tel:+91 70430 00101">+91 70430 00101</a>
                        </div>
                    </div>
                    <div class="row pt-3 align-items-center mb-2 px-sm-0 px-2">
                        <div class="col-2 text-center">
                            <picture>
                                ...
                                <img class="img-fluid" src="https://www.bankersheart.com/assets/img/email-icon-img.svg" alt="bankers heart institute
                                    call">
                            </picture>
                        </div>
                        <div class="col-10 ps-0">
                    ...
                    <div>
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3691.0073447920477!2d73.21908087506984!3d22.315561979675717!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395fcf6ea829f505%3A0x438e8ee055414642!2sHarni%20-%20Warasiya%20Ring%20Rd%2C%20Vadodara%2C%20Gujarat%20390006!5e0!3m2!1sen!2sin!4v1738319035427!5m2!1sen!2sin"
