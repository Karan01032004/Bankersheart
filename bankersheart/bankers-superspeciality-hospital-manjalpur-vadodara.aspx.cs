...
{
    public partial class bankers_superspeciality_hospitals : System.Web.UI.Page
    {
        ...
        private void BindAwards()
        {
            ...
            string hospitalName = "Bankers Superspeciality Hospital, Manjalpur"; // Change this as needed
        ...
        private void Facilities()
        {
            ...
            //   WHERE HospitalName = 'Bankers Superspeciality Hospital, Manjalpur' 
            //   ORDER BY added_date DESC";
