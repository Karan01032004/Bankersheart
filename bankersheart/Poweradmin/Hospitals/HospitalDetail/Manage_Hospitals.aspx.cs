...
namespace bankersheart.Poweradmin.Hospitals.HospitalDetail
{
    public partial class Manage_Hospitals : System.Web.UI.Page
    {
        string TableName = "[bankers_usr].[Hospitals]";
        ...
        private void fill_data(string id)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                {
                    img_banner.ImageUrl = ConfigurationManager.AppSettings["siteurl"].ToString() + "poweradmin/WebFiles/Hospitals/" + dt.Rows[0]["image"].ToString();
                }
            }
        }
        protected void btn_submit_Click(object sender, EventArgs e)
        {
            ...
            foreach (HttpPostedFile uploadedFile in fpbannerimage.PostedFiles)
            {
                ...
                {
                    string filepath = "~/poweradmin/WebFiles/Hospitals/" + fileName;
            ...
            {
                string query = "INSERT INTO " + TableName + " (title, image, description, added_date, added_ip) VALUES(@Title, @Image, @Description, @AddedDate, @AddedIP)";
            ...
            string msg = "Hospitals added successfully.";
            Response.Redirect("view_Hospitals.aspx?msg=" + msg);
        }
        ...
        protected void btn_Update_Click(object sender, EventArgs e)
        {
            ...
            string query = "UPDATE " + TableName + " SET title=@Title, description=@Description, modified_date=@ModifiedDate, modified_ip=@ModifiedIP";
        ...
        new SqlParameter("@ID", SqlDbType.Int) { Value = id }
            ...
            string msg = "Hospitals updated successfully.";
            Response.Redirect("view_Hospitals.aspx?msg=" + msg);
        }
        //    protected void btn_submit_Click(object sender, EventArgs e)
        //    {
        ...
        //                    string webpimagesPath = Path.Combine(Server.MapPath("~/poweradmin/WebFiles/Hospitals/"));
        ...
        {
            Response.Redirect("view_Hospitals.aspx");
        }
    }
}
