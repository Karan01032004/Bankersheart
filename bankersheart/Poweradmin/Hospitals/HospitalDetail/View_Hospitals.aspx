<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/bankersheartMaster.Master" AutoEventWireup="true" CodeBehind="View_Hospitals.aspx.cs" Inherits="bankersheart.Poweradmin.Hospitals.HospitalDetail.View_Hospitals" %>
...
<%--        <asp:LinkButton ID="Awards_Achivement" runat="server" class="btn sbold white btn-sm" PostBackUrl="~/PowerAdmin/Hospitals/Manage_Hospitals.aspx"><i class="fa fa-plus"></i> Add Hospitals</asp:LinkButton>--%>
    </div>
    <%--  <div class="tools">
                                            ...
                                            <tr class="odd gradeX">
                                              ...
                                              <%--  <td class="hidden">
                                               ...
                                               <%-- </td>--%>
                                                ...
                                                <td>
                                <img src='<%# ResolveUrl("~/Poweradmin/Webfiles/Hospitals/" + Eval("image")) %>' width="200" />
