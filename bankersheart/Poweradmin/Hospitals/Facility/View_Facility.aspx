<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/bankersheartMaster.Master" AutoEventWireup="true" CodeBehind="View_Facility.aspx.cs" Inherits="bankersheart.Poweradmin.Hospitals.Facility.View_Facility" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="actions">
       ...
       <asp:LinkButton ID="Awards_Achivement" runat="server" class="btn sbold white btn-sm" PostBackUrl="~/PowerAdmin/Hospitals/Facility/Manage_Facility.aspx"><i class="fa fa-plus"></i> Add Facility</asp:LinkButton>
    </div>
    <%--  <div class="tools">
                                            ...
                                            <tr class="odd gradeX">
                                              ...
                                              <%--  <td class="hidden">
                                               ...
                                               <%-- </td>--%>
                                                ...
                                                <td>
                                <img src='<%# ResolveUrl("~/Poweradmin/Webfiles/Facility/" + Eval("image")) %>' width="200" />
