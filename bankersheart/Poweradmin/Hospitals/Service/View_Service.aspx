<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/bankersheartMaster.Master" AutoEventWireup="true" CodeBehind="View_Service.aspx.cs" Inherits="bankersheart.Poweradmin.Hospitals.Service.View_Service" %>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box green">
                ...
                <i class="fa fa-angle-down"></i>
                        ...
                        <asp:LinkButton ID="Awards_Achivement" runat="server" class="btn sbold white btn-sm" PostBackUrl="~/PowerAdmin/Hospitals/Service/Manage_Service.aspx"><i class="fa fa-plus"></i> Add Service</asp:LinkButton>
                    </div>
                    <%--  <div class="tools">
                                    ...
                                    <asp:Repeater ID="rpt_data" runat="server" OnItemCommand="rpt_data_ItemCommand" OnItemDataBound="rpt_data_ItemDataBound">
                                        <ItemTemplate>
                                            <tr class="odd gradeX">
                                                ...
                                                <%-- </td>--%>
                                                <td><%# Eval("FormattedHospitalName") %></td>
                                                ...
                                                <%--     <td>
                                <img src='<%# ResolveUrl("~/Poweradmin/Webfiles/Service/" + Eval("image")) %>' width="200" />
                                                          </td>--%>
                                                <asp:HiddenField ID="hdnID" runat="server" Value='<%# Eval("id") %>' />
                                                <td>
                                                    <asp:HiddenField ID="hdnDisId" runat="server" Value='<%#Eval("sortorder") %>' />
                                                    <div style="display: flex; align-items: center;">
                                                        <asp:TextBox ID="txt_displayorder" CssClass="form-control" runat="server" Text='<%#Eval("sortorder") %>' Width="70%" OnKeyPress="return isNumber(event);"></asp:TextBox>
