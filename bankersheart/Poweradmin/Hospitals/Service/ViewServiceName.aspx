<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/bankersheartMaster.Master" AutoEventWireup="true" CodeBehind="ViewServiceName.aspx.cs" Inherits="bankersheart.Poweradmin.Hospitals.Service.ViewServiceName" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <i class="icon-home"></i>
                <a href="View_Service.aspx">Service Name</a>
                <i class="fa fa-angle-right"></i>
            </li>
        </ul>
    </div>
    ...
    <div class="actions">
       ...
       <asp:LinkButton ID="Awards_Achivement" runat="server" class="btn sbold white btn-sm" PostBackUrl="~/PowerAdmin/Hospitals/Service/AddServiceName.aspx"><i class="fa fa-plus"></i> Add Service Name</asp:LinkButton>
    </div>
    <%--  <div class="tools">
