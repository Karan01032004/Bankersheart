<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/bankersheartMaster.Master" AutoEventWireup="true" CodeBehind="view-banner.aspx.cs" Inherits="bankersheart.Poweradmin.Banner.view_banner" %>
...
<%--        <asp:LinkButton ID="Awards_Achivement" runat="server" class="btn sbold white btn-sm" PostBackUrl="~/PowerAdmin/Banner/manage-banner.aspx"><i class="fa fa-plus"></i> Add Banner</asp:LinkButton>--%>
    </div>
    <%--  <div class="tools">
                                    ...
                                    <asp:Repeater ID="rpt_data" runat="server" OnItemCommand="rpt_data_ItemCommand" OnItemDataBound="rpt_data_ItemDataBound">
                                        <ItemTemplate>
                                            <tr class="odd gradeX">
                                               ...
                                               <%-- <td>
                                                    <img src="../webfiles/banner/<%# Eval("banner_image") %>" width="200" />
                                                </td>--%>
                                 <asp:HiddenField ID="hdnID" runat="server" Value='<%# Eval("id") %>' />
