<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/bankersheartMaster.Master" AutoEventWireup="true" CodeBehind="Career.aspx.cs" Inherits="bankersheart.Poweradmin.Career" %>
...
<%# !string.IsNullOrEmpty(Eval("uploadResume").ToString()) ?   "<a href='" + ResolveUrl("~/careerresume/") + Eval("uploadResume") + "' target='_blank' class='btn btn-primary'>   <i class='fa fa-eye'></i> View</a>" : "No File" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="extrajs" runat="server">
     <script>
         $(document).ready(function () {
             ...
             $('#career').addClass("start active");
             $('#career').addClass("open");
         });
     </script>
    <script>
        $(document).ready(function () {
