<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/bankersheartMaster.Master" AutoEventWireup="true" CodeBehind="View_Position.aspx.cs" Inherits="bankersheart.Poweradmin.View_Position" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <i class="icon-home"></i>
                <a href="View_Position.aspx">Position</a>
                <i class="fa fa-angle-right"></i>
            </li>
        </ul>
    </div>
    ...
    <div class="actions">
       ...
       <asp:LinkButton ID="Awards_Achivement" runat="server" class="btn sbold white btn-sm" PostBackUrl="~/PowerAdmin/Add_Position.aspx"><i class="fa fa-plus"></i> Add Position</asp:LinkButton>
    </div>
    <%--  <div class="tools">
