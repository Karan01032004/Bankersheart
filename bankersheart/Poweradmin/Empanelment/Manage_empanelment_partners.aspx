<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/bankersheartMaster.Master" AutoEventWireup="true" CodeBehind="Manage_empanelment_partners.aspx.cs" Inherits="bankersheart.Poweradmin.Insurance_Partners.Manage_insurance_partners" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <i class="icon-home"></i>
                <a href="View_empanelment_partners.aspx">Empanelment</a>
                <i class="fa fa-angle-right"></i>
            </li>
        </ul>
    </div>
            ...
            <div class="portlet light ">
                <div class="portlet-title">
                    <div class="caption font-red-sunglo">
                        ...
                        <span class="caption-subject font-blue-sharp bold uppercase">Manage Empanelment</span>
                    </div>
                    <div class="actions">
                        <div class="btn-group">
                            <a class="btn sbold blue-sharp" href="javascript:;" onclick="location.href='View_empanelment_partners.aspx'">Back</a>
                ...
                <div class="portlet-body">
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Title</label><span style="color: red">*</span>&nbsp&nbsp[Note: Title which is going to display on Empanelment Page]
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Logo</label><span style="color: red">*</span>&nbsp&nbsp[Note: Empanelment which is going to display on Home Page and empanelment-bankers-group-of-hospitals page]<br />
...
<%--                                        [Recommended Dimension for Mobile - Width : <%=ConfigurationManager.AppSettings["MobileBannerWidth"]%>px - Height : <%=ConfigurationManager.AppSettings["MobileBannerHeight"]%>px].--%>
   ...
   <asp:Image ID="img_banner" runat="server" Width="200" />
                    ...
                    <div class="form-actions text-center">
                        ...
                        <asp:Button ID="btn_Update" runat="server" Text="Submit" CssClass="btn blue-sharp" ValidationGroup="vgValidate" OnClick="btn_Update_Click" OnClientClick="return confirm('Are you sure want to update Empanelment?');" />
...
<script src="https://code.jquery.com/ui/1.13.2/jquery-ui.min.js"></script>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#insurance').addClass("start active");
            $('#insurance').addClass("open");
        });
    </script>
