<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/bankersheartMaster.Master" AutoEventWireup="true" CodeBehind="View_empanelment_partners.aspx.cs" Inherits="bankersheart.Poweradmin.Insurance_Partners.View_insurance_partners" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="actions">
        ...
        <asp:LinkButton ID="Awards_Achivement" runat="server" class="btn sbold white btn-sm" PostBackUrl="~/PowerAdmin/Empanelment/Manage_empanelment_partners.aspx"><i class="fa fa-plus"></i> Add Empanelment</asp:LinkButton>
    </div>
    <%--  <div class="tools">
                                            ...
                                            <tr class="odd gradeX">
                                              ...
                                              <%--  <td class="hidden">
                                               ...
                                               <%-- </td>--%>
                                                ...
                                                <td>
                                <img src='<%# ResolveUrl("~/Poweradmin/Webfiles/insurance_partners/" + Eval("image")) %>' width="200" />
