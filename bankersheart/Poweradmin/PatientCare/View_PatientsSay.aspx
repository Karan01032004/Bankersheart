<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/bankersheartMaster.Master" AutoEventWireup="true" CodeBehind="View_PatientsSay.aspx.cs" Inherits="bankersheart.Poweradmin.PatientCare.View_PatientsSay" %>
                                            ...
                                            <tr class="odd gradeX">
                                              ...
                                              <%--  <td class="hidden">
                                               ...
                                               <%-- </td>--%>
                                                ...
                                                <td>
                                <img src='<%# ResolveUrl("~/Poweradmin/Webfiles/PatientsSay/" + Eval("image")) %>' width="200" />

                                                    <asp:HiddenField ID="hdnID" runat="server" Value='<%# Eval("id") %>' />
                                                </td>

                            <td><%# Eval("Patient_Date", "{0:dd/MM/yyyy}") %></td>
