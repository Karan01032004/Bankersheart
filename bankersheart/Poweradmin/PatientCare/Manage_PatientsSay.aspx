<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/bankersheartMaster.Master" ValidateRequest="false"  AutoEventWireup="true" CodeBehind="Manage_PatientsSay.aspx.cs" Inherits="bankersheart.Poweradmin.PatientCare.Manage_PatientsSay" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <i class="icon-home"></i>
                <a href="View_PatientsSay.aspx">What Our Patients Say</a>
                <i class="fa fa-angle-right"></i>
            </li>
        </ul>
    </div>
            ...
            <div class="portlet light ">
                <div class="portlet-title">
                    <div class="caption font-red-sunglo">
                        ...
                        <span class="caption-subject font-blue-sharp bold uppercase">Manage What Our Patients Say</span>
                    </div>
                    <div class="actions">
                        <div class="btn-group">
                            <a class="btn sbold blue-sharp" href="javascript:;" onclick="location.href='view_PatientsSay.aspx'">Back</a>
    ...
    <div class="form-group">
        <label for="txt_CampDate">Date</label><span style="color: red">*</span>
  <div class="input-group">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Name</label><span style="color: red">*</span>&nbsp&nbsp[Note: Title which is going to display on About_Awards_Achivement Page]
...
<%--        <asp:RequiredFieldValidator ID="rvdescription" runat="server" ControlToValidate="txt_description" ErrorMessage="Please fill out this field." ForeColor="Red" Display="Dynamic" ValidationGroup="UserDetails"></asp:RequiredFieldValidator>--%>
                     ...
                     <small style="color: grey">[Maximum 500 Characters allowed]
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Image</label><span style="color: red">*</span>&nbsp&nbsp[Note: Medical Camp which is going to display on Home Page]<br />
...
<%--                                        [Recommended Dimension for Mobile - Width : <%=ConfigurationManager.AppSettings["MobileBannerWidth"]%>px - Height : <%=ConfigurationManager.AppSettings["MobileBannerHeight"]%>px].--%>
   ...
   <asp:Image ID="img_banner" runat="server" Width="200" />
                    ...
                    <div class="form-actions text-center">
                        ...
                        <asp:Button ID="btn_Update" runat="server" Text="Submit" CssClass="btn blue-sharp" ValidationGroup="vgValidate" OnClick="btn_Update_Click" OnClientClick="return confirm('Are you sure want to update What Our Patients Say details?');" />
...
<script src="https://code.jquery.com/ui/1.13.2/jquery-ui.min.js"></script>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#li_PatientCare').addClass("start active");
            $('#li_PatientCare').addClass("open");
        });
    </script>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        // Initialize the datepicker with 'dd-mm-yyyy' format and limit to past and current dates
        $('#<%= txt_CampDate.ClientID %>').datepicker({
            dateFormat: 'dd-mm-yy', // Ensure the format is 'dd-mm-yyyy'
            changeMonth: true,
            changeYear: true,
            showAnim: 'fadeIn',
            maxDate: 0, // Limit the selectable date range to today and past dates
        });
