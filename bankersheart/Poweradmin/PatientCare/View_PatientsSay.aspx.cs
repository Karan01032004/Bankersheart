...
{
    public partial class View_PatientsSay : System.Web.UI.Page
    {
        ...
        protected void rpt_data_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            {
                string sQuery = @"delete from [bankers_usr].[PatientsSay] where id='" + hdnID.Value + "'";
                new DAL().ExecuteNonQuery(sQuery, CommandType.Text, null);

                ltr_Success.Text = "What Our Patients Say deleted.";
                div_Success.Visible = true;
