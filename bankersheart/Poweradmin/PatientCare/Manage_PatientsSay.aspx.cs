...
namespace bankersheart.Poweradmin.PatientCare
{
    public partial class Manage_PatientsSay : System.Web.UI.Page
    {
        string TableName = "[bankers_usr].[PatientsSay]";
        ...
        {
            DataTable dt = new DAL().GetDataTable("select * from " + TableName + " where id='" + id + "' order by Patient_Date asc", CommandType.Text, null);
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                {
                    img_banner.ImageUrl = ConfigurationManager.AppSettings["siteurl"].ToString() + "poweradmin/WebFiles/PatientsSay/" + dt.Rows[0]["image"].ToString();
                }
            }
        }
        ...
        protected void btn_submit_Click(object sender, EventArgs e)
        {
            ...
            foreach (HttpPostedFile uploadedFile in fpbannerimage.PostedFiles)
            {
                ...
                {
                    string filepath = "~/poweradmin/WebFiles/PatientsSay/" + fileName;
            ...
            {
                string query = @"INSERT INTO " + TableName + " (title, image, description, Patient_Date, added_date, added_ip)  VALUES(@Title, @Image, @Description, @CampDate, @AddedDate, @AddedIP)";
            ...
            string msg = "What Our Patients Say added successfully.";
            Response.Redirect("view_PatientsSay.aspx?msg=" + msg);
        }
        ...
        new SqlParameter("@ID", SqlDbType.Int) { Value = id }
            ...
            string msg = "What Our Patients Say updated successfully.";
            Response.Redirect("view_PatientsSay.aspx?msg=" + msg);
        }
        ...
        //                    string webpimagesPath = Path.Combine(Server.MapPath("~/poweradmin/WebFiles/PatientsSay/"));
        ...
        {
            Response.Redirect("view_PatientsSay.aspx");
        }
    }
}
