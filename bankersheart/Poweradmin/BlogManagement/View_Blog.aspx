<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/bankersheartMaster.Master" AutoEventWireup="true" CodeBehind="View_Blog.aspx.cs" Inherits="bankersheart.Poweradmin.BlogManagement.View_Blog" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="actions">
     ...
     <asp:LinkButton ID="Awards_Achivement" runat="server" class="btn sbold white btn-sm" PostBackUrl="~/PowerAdmin/BlogManagement/Manage_Blog.aspx"><i class="fa fa-plus"></i> Add Blog Management</asp:LinkButton>
    </div>
    <%--  <div class="tools">
                ...
                <div class="portlet-body">
                    <asp:UpdatePanel ID="up1" runat="server">
                        <ContentTemplate>
                                    ...
                                    <tr>
                                       ...
                                       <%--     <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                        ...
                                        <th style="width: 20%">Summary</th>
                                             <th style="width: 15%">Blog Date</th>
                            ...
                            <td><%# Eval("Blog_Date", "{0:dd/MM/yyyy}") %></td>

                                                <td>
                                <img src='<%# ResolveUrl("~/Poweradmin/Webfiles/BlogManagement/" + Eval("image")) %>' width="200" />
