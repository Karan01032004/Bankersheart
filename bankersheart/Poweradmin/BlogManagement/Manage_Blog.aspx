<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/bankersheartMaster.Master"  ValidateRequest="false" AutoEventWireup="true" CodeBehind="Manage_Blog.aspx.cs" Inherits="bankersheart.Poweradmin.BlogManagement.Manage_Blog" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <i class="icon-home"></i>
                <a href="https://www.bankersheart.com/Poweradmin/BlogManagement/View_Blog.aspx">Blog Management</a>
                <i class="fa fa-angle-right"></i>
            </li>
        </ul>
    </div>
            ...
            <div class="portlet light ">
                <div class="portlet-title">
                    <div class="caption font-red-sunglo">
                        ...
                        <span class="caption-subject font-blue-sharp bold uppercase">Manage Blog Management</span>
                    </div>
                    <div class="actions">
                        <div class="btn-group">
                            <a class="btn sbold blue-sharp" href="javascript:;" onclick="location.href='https://www.bankersheart.com/Poweradmin/BlogManagement/view_Blog.aspx'">Back</a>
    ...
    <div class="form-group">
        <label for="txt_CampDate">Blog Date</label><span style="color: red">*</span>
  <div class="input-group">
   ...
   <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txt_CampDate" ErrorMessage="Please fill out this field." ForeColor="Red" Display="Dynamic" ValidationGroup="UserDetails"></asp:RequiredFieldValidator>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Title</label><span style="color: red">*</span>&nbsp&nbsp[Note: Title which is going to display on Our-Blog Page]
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Summary</label><span style="color: red">*</span>&nbsp&nbsp[Note: Summary which is going to display on Our-Blog Page]
   ...
   <div class="col-md-12">
       <div class="form-group">
           <label>Description</label><span style="color: red">*</span>&nbsp&nbsp[Note: Description which is going to display on Our-Blog Page]
...
<%--        <asp:RequiredFieldValidator ID="rvdescription" runat="server" ControlToValidate="txt_description" ErrorMessage="Please fill out this field." ForeColor="Red" Display="Dynamic" ValidationGroup="UserDetails"></asp:RequiredFieldValidator>--%>
                     ...
                     <small style="color: grey">[Maximum 500 Characters allowed]
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Image</label><span style="color: red">*</span>&nbsp&nbsp[Note: This image is going to display on Our-Blog Page]<br />
...
<%--                                        [Recommended Dimension for Mobile - Width : <%=ConfigurationManager.AppSettings["MobileBannerWidth"]%>px - Height : <%=ConfigurationManager.AppSettings["MobileBannerHeight"]%>px].--%>
   ...
   <asp:Image ID="img_banner" runat="server" Width="200" />
                    ...
                    <div class="form-actions text-center">
                        ...
                        <asp:Button ID="btn_Update" runat="server" Text="Submit" CssClass="btn blue-sharp" ValidationGroup="vgValidate" OnClick="btn_Update_Click" OnClientClick="return confirm('Are you sure want to update Blog details?');" />
...
<script src="https://code.jquery.com/ui/1.13.2/jquery-ui.min.js"></script>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#BlogManagement').addClass("start active");
            $('#BlogManagement').addClass("open");
        });
    </script>
