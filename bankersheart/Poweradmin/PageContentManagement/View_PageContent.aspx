<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/bankersheartMaster.Master" AutoEventWireup="true" CodeBehind="View_PageContent.aspx.cs" Inherits="bankersheart.Poweradmin.PageContentManagement.View_PageContent" %>
                                        ...
                                        <ItemTemplate>
                                            <tr class="odd gradeX">
                                              ...
                                              <%--  <td class="hidden">
                                               ...
                                               <td><%# Eval("modified_date", "{0:dd MMMM yyyy}") %></td>
