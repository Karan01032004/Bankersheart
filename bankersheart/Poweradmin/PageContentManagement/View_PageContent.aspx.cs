...
{
    public partial class View_PageContent : System.Web.UI.Page
    {
        ...
        protected void rpt_data_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("Manage_PageContent.aspx?id=" + hdnID.Value);
            }

            //if (e.CommandName == "delete")
            //{
            //    string sQuery = @"delete from Service where id='" + hdnID.Value + "'";
