<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/bankersheartMaster.Master" ValidateRequest="false" AutoEventWireup="true" CodeBehind="Manage_InterestingCases.aspx.cs" Inherits="bankersheart.Poweradmin.Education.Manage_InterestingCases" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <i class="icon-home"></i>
                <a href="view_InterestingCases.aspx">Interesting Cases</a>
                <i class="fa fa-angle-right"></i>
            </li>
        </ul>
    </div>
            ...
            <div class="portlet light ">
                <div class="portlet-title">
                    <div class="caption font-red-sunglo">
                        ...
                        <span class="caption-subject font-blue-sharp bold uppercase">Manage Interesting Cases</span>
                    </div>
                    <div class="actions">
                        <div class="btn-group">
                            <a class="btn sbold blue-sharp" href="javascript:;" onclick="location.href='view_InterestingCases.aspx'">Back</a>
    ...
    <div class="form-group">
        <label for="txt_CampDate">Case Date</label><span style="color: red">*</span>
  <div class="input-group">
    ...
    <div class="col-md-12">
     <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Doctors Name</label><span style="color: red">*</span>&nbsp&nbsp[Note: Doctors Name which is going to display on Interesting Cases Page]
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Short Description</label><span style="color: red">*</span>&nbsp&nbsp[Note: Short Description which is going to display on Interesting Cases Page]
   ...
   <div class="col-md-12">
       <div class="form-group">
           <label>Description</label><span style="color: red">*</span>&nbsp&nbsp[Note: Description which is going to display on Interesting Cases Page]
...
<%--        <asp:RequiredFieldValidator ID="rvdescription" runat="server" ControlToValidate="txt_description" ErrorMessage="Please fill out this field." ForeColor="Red" Display="Dynamic" ValidationGroup="UserDetails"></asp:RequiredFieldValidator>--%>
                     ...
                     <small style="color: grey">[Maximum 500 Characters allowed]
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Interesting Cases Category Image</label><span style="color: red">*</span>&nbsp&nbsp[Note: Interesting Cases Category Image are going to display on Interesting Cases Page]<br />
...
<%--                                        [Recommended Dimension for Mobile - Width : <%=ConfigurationManager.AppSettings["MobileBannerWidth"]%>px - Height : <%=ConfigurationManager.AppSettings["MobileBannerHeight"]%>px].--%>
       ...
       <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="Category"
           ...
           ValidationGroup="UserDetails"></asp:RequiredFieldValidator>
                                    ...
                                    <div style="text-align: left; margin-left: 0px;">
        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="Category"
...
<asp:Repeater ID="Repeater1" runat="server">
    <ItemTemplate>
        <div style="display: inline-block; height: 150px; width: 200px; border: 2px solid #ccc; padding: 10px; box-sizing: border-box; text-align: center; overflow: hidden;">
            <img src='<%# ResolveUrl("~/poweradmin/WebFiles/InterestingCasesCategory/" + Eval("image")) %>' 
                 ...
                 style="width: 100%; height: 100%; object-fit: cover; border-radius: 5px;" />
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Interesting Cases Gallery Image</label><span style="color: red">*</span>&nbsp&nbsp[Note: Interesting Cases Gallery Images are going to display on interesting-cases-details.aspx]<br />
                                    <span class="btn blue-steel btn-outline btn-file">
...
<%--                                        [Recommended Dimension for Mobile - Width : <%=ConfigurationManager.AppSettings["MobileBannerWidth"]%>px - Height : <%=ConfigurationManager.AppSettings["MobileBannerHeight"]%>px].--%>
        ...
        <asp:RegularExpressionValidator ID="RegularExpressionValidator7" runat="server" ControlToValidate="fpbannerimage"
            ...
            ValidationGroup="UserDetails" SetFocusOnError="true"></asp:RegularExpressionValidator>
                    ...
                    <div class="form-actions text-center">
                        ...
                        <asp:Button ID="btn_Update" runat="server" Text="Submit" CssClass="btn blue-sharp" ValidationGroup="vgValidate" OnClick="btn_Update_Click" OnClientClick="return confirm('Are you sure want to update Interesting Cases details?');" />
    ...
    <ItemTemplate>
        <div style="display: inline-block; height: 220px; width: 200px; border: 2px solid #ccc; padding: 10px; box-sizing: border-box; text-align: center; overflow: hidden;">
            <img src='<%# ResolveUrl("~/poweradmin/WebFiles/InterestingCases/" + Eval("image")) %>' alt="Image" class="img-thumbnail"   style="width: 100%; height: 150px; object-fit: cover; border-radius: 5px;" />
            <br />
