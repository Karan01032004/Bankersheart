<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/bankersheartMaster.Master" AutoEventWireup="true" CodeBehind="View_JournalClubDetial.aspx.cs" Inherits="bankersheart.Poweradmin.Education.View_JournalClubDetial" %>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box green">
                ...
                <i class="fa fa-angle-down"></i>
                        ...
                        <asp:LinkButton ID="Awards_Achivement" runat="server" class="btn sbold white btn-sm" PostBackUrl="~/PowerAdmin/Education/Manage_JournalClubDetial.aspx"><i class="fa fa-plus"></i> Add Journal Club Detail</asp:LinkButton>
                    </div>
                    <%--  <div class="tools">
                            ...
                            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 15%">Journal Date</th>

                                        <th style="width: 15%">YouTube Video</th>
                                    ...
                                    <asp:Repeater ID="rpt_data" runat="server" OnItemCommand="rpt_data_ItemCommand" OnItemDataBound="rpt_data_ItemDataBound">
                                        <ItemTemplate>
                                            <tr class="odd gradeX">
                                                ...
                                                <td><%# Eval("Journal_Date", "{0:dd/MM/yyyy}") %></td>

                                                <td>
                                                    <iframe width="200" height="150" src='<%# GetYouTubeIframeSrc(Eval("YoutubeLink")) %>' frameborder="0" allowfullscreen></iframe>
