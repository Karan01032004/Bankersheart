...
{
    public partial class Manage_InterestingCases : System.Web.UI.Page
    {
        string TableName = "[bankers_usr].[InterestingCases]";
        ...
        private void fill_data(string id)
        {
            ...
            DataTable dt = new DAL().GetDataTable("SELECT * FROM " + TableName + " WHERE id='" + id + "' ORDER BY InterestingCases_Date ASC", CommandType.Text, null);
            if (dt.Rows.Count > 0)
            {
            ...
            DataTable dt1 = new DAL().GetDataTable("SELECT image FROM [bankers_usr].[InterestingCases_Images] WHERE InterestingCases_id = '" + id + "' ORDER BY added_date DESC", CommandType.Text, null);
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                txt_CampDate.Text = Convert.ToDateTime(dt.Rows[0]["InterestingCases_Date"]).ToString("dd-MM-yyyy");
            }
        ...
        protected void RemoveImage(object sender, CommandEventArgs e)
        {
            ...
            string deleteImageQuery = @"DELETE FROM [bankers_usr].[InterestingCases_Images] WHERE image = @Image AND InterestingCases_id = @NewsatBankersId";
        ...
        new SqlParameter("@NewsatBankersId", SqlDbType.Int) { Value = Request.QueryString["ID"].ToString() }
            ...
            string filePath = Server.MapPath("~/poweradmin/WebFiles/InterestingCases/" + imageToRemove);
            ...
            Response.Redirect("Manage_InterestingCases.aspx?ID=" + Request.QueryString["ID"].ToString() + "&msg=" + Server.UrlEncode(msg));
        }
        ...
        protected void btn_submit_Click(object sender, EventArgs e)
        {
            ...
            foreach (HttpPostedFile uploadedFile in fpbannerimage.PostedFiles)
            {
                ...
                string filepath = "~/poweradmin/WebFiles/InterestingCases/" + fileName;
            ...
            //    string categoryFilePath = "~/poweradmin/WebFiles/InterestingCasesCategory/" + categoryFileName;
            ...
            string query = @"INSERT INTO " + TableName + " (Browsertitle, MetaTag,title,titlelink, shortdescription, description, InterestingCases_Date, added_date, added_ip, image)   VALUES(@Browsertitle, @MetaTag,@Title,@titlelink, @ShortDescription, @Description, @EventsatBankersDate, @AddedDate, @AddedIP, @Image); SELECT SCOPE_IDENTITY(); ";
    ...
    new SqlParameter("@MetaTag", SqlDbType.NVarChar) { Value = txtMeta.Text.Replace("'", "''") },
        ...
        new SqlParameter("@Image", SqlDbType.NVarChar) { Value = categoryImageFileName } // Save category image filename
            ...
            {
                string imageQuery = @"INSERT INTO [bankers_usr].[InterestingCases_Images] (InterestingCases_id, image, added_date) 
            ...
            string msg = "InterestingCases added successfully.";
            Response.Redirect("View_InterestingCases.aspx?msg=" + msg);
        }
        ...
        protected void btn_Update_Click(object sender, EventArgs e)
        {
            ...
            string query = @"UPDATE " + TableName + " SET " +
                         "Browsertitle=@Browsertitle, " +
                           ...
                           "InterestingCases_Date=@CampDate, " +
            ...
            List<SqlParameter> parameters = new List<SqlParameter>
    {
        ...
        new SqlParameter("@ID", SqlDbType.Int) { Value = id }
            ...
            foreach (string fileName in uploadedFileNames)
            {
                string imageQuery = @"INSERT INTO [bankers_usr].[InterestingCases_Images] (InterestingCases_id, image, added_date) VALUES (@MedicalCampId, @Image, @AddedDate)";
                SqlParameter[] imageParameters = {
            ...
            string msg = "InterestingCases updated successfully.";
            Response.Redirect("view_InterestingCases.aspx?msg=" + msg);
        }
        //protected void btn_Update_Click(object sender, EventArgs e)
        //{
        ...
        //                   "InterestingCases_Date=@CampDate, " +
        //                   "modified_date=@ModifiedDate, " +
        //                   "modified_ip=@ModifiedIP WHERE id=@ID";
        ...
        //    string msg = "Interesting Cases updated successfully.";
        //    Response.Redirect("view_InterestingCases.aspx?msg=" + msg);
        //}

        protected void btn_cancel_Click(object sender, EventArgs e)
        {
            Response.Redirect("view_InterestingCases.aspx");
        }
    }
}
