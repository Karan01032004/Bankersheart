<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/bankersheartMaster.Master" AutoEventWireup="true" CodeBehind="View_InterestingCases.aspx.cs" Inherits="bankersheart.Poweradmin.Education.View_InterestingCases" %>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box green">
                ...
                <i class="fa fa-angle-down"></i>
                        ...
                        <asp:LinkButton ID="Awards_Achivement" runat="server" class="btn sbold white btn-sm" PostBackUrl="~/PowerAdmin/Education/Manage_InterestingCases.aspx"><i class="fa fa-plus"></i> Add Interesting Cases</asp:LinkButton>
                    </div>
                    <%--  <div class="tools">
                            ...
                            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 15%">Case Date</th>
                                    ...
                                    <asp:Repeater ID="rpt_data" runat="server" OnItemCommand="rpt_data_ItemCommand" OnItemDataBound="rpt_data_ItemDataBound">
                                        <ItemTemplate>
                                            <tr class="odd gradeX">
                                                ...
                                                <td><%# Eval("InterestingCases_Date", "{0:dd/MM/yyyy}") %></td>
                                           <%--     <td><%# Eval("InterestingCases_Date", "{0:dd/MM/yyyy}") %></td>--%>
                                              
                                                <td>
                                                    <img src='<%# ResolveUrl("~/Poweradmin/Webfiles/InterestingCasesCategory/" + Eval("image")) %>' width="200" />
<asp:HiddenField ID="hdnID" runat="server" Value='<%# Eval("id") %>' />
                                                </td>
