<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/bankersheartMaster.Master" ValidateRequest="false" AutoEventWireup="true" CodeBehind="Manage_DoctorsDetails.aspx.cs" Inherits="bankersheart.Poweradmin.Doctors_Details.Manage_DoctorsDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="portlet light ">
                <div class="portlet-title">
                    <div class="caption font-red-sunglo">
                        ...
                        <span class="caption-subject font-blue-sharp bold uppercase">Manage Doctors Details</span>
                    </div>
                    <div class="actions">
                        <div class="btn-group">
                            <a class="btn sbold blue-sharp" href="javascript:;" onclick="location.href='view_DoctorsDetails.aspx'">Back</a>
    ...
    <label>Hospital Name</label><span style="color: red">*</span><br />
                                  ...
                                  <asp:CheckBoxList ID="chkHospitals" runat="server" RepeatDirection="Vertical">
            <asp:ListItem Value="Bankers Superspeciality Hospital, Manjalpur">Bankers Superspeciality Hospital, Manjalpur</asp:ListItem>
            <asp:ListItem Value="Bankers Heart Institute, Vadodara">Bankers Heart Institute, Vadodara</asp:ListItem>
            <asp:ListItem Value="Bankers Heart and Multi Specialty Hospital, Warasia">Bankers Heart and Multi Specialty Hospital, Warasia</asp:ListItem>
            <asp:ListItem Value="Bankers Heart Institute, Surat">Bankers Heart Institute, Surat</asp:ListItem>
        </asp:CheckBoxList>
                   ...
                   <%-- <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Doctor Name</label><span style="color: red">*</span>&nbsp&nbsp[Note: Doctor Name which is going to display on meet-our-doctors Page]
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Doctor profession</label><span style="color: red">*</span>&nbsp&nbsp[Note: Summary which is going to display on meet-our-doctors Page]
                                    <asp:TextBox ID="txt_Summary" runat="server" CssClass="form-control"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="rvSummary" runat="server" ControlToValidate="txt_Summary" ErrorMessage="Please fill out this field." ForeColor="Red" Display="Dynamic" ValidationGroup="UserDetails"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                        </div>  
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Doctor specialties</label><%--<span style="color: red">*</span>--%>&nbsp&nbsp[Note: Specialties which is going to display on meet-our-doctors Page]
                                    <asp:TextBox ID="txt_specialties" runat="server" CssClass="form-control"></asp:TextBox>
<%--                                    <asp:RequiredFieldValidator ID="rvspecialties" runat="server" ControlToValidate="txt_specialties" ErrorMessage="Please fill out this field." ForeColor="Red" Display="Dynamic" ValidationGroup="UserDetails"></asp:RequiredFieldValidator>--%>
                                </div>
                            </div>
                        </div>    
...
<div class="col-md-12">
    <div class="form-group">
        <label>Description</label><%--<span style="color: red">*</span>--%>&nbsp&nbsp[Note: Description which is going to display on meet-our-doctors Page]
...
<%--     <asp:RequiredFieldValidator ID="rvdescription" runat="server" ControlToValidate="txt_description" ErrorMessage="Please fill out this field." ForeColor="Red" Display="Dynamic" ValidationGroup="UserDetails"></asp:RequiredFieldValidator>--%>
                  ...
                  <small style="color: grey">[Maximum 500 Characters allowed]
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Image</label><span style="color: red">*</span>&nbsp&nbsp[Note: Image which is going to display on meet-our-doctors Page]<br />
...
<%--                                        [Recommended Dimension for Mobile - Width : <%=ConfigurationManager.AppSettings["MobileBannerWidth"]%>px - Height : <%=ConfigurationManager.AppSettings["MobileBannerHeight"]%>px].--%>
   ...
   <asp:Image ID="img_banner" runat="server" Width="200" />
                    ...
                    <div class="form-actions text-center">
                        ...
                        <asp:Button ID="btn_Update" runat="server" Text="Submit" CssClass="btn blue-sharp" ValidationGroup="vgValidate" OnClick="btn_Update_Click" OnClientClick="return confirm('Are you sure want to update Doctors details?');" />
