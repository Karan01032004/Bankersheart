...
{
    public partial class View_MedicalCamp : System.Web.UI.Page
    {
        ...
        protected void rpt_data_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("Manage_MedicalCamp.aspx?id=" + hdnID.Value);
            }
            ...
            if (e.CommandName == "delete")
            {
                ...
                string deleteImagesQuery = @"DELETE FROM [bankers_usr].[Medical_Camp_Images] WHERE Medical_Camp_id = @Eventsatbankers_id";
            ...
            new SqlParameter("@Eventsatbankers_id", SqlDbType.Int) { Value = idToDelete }
                ...
                string deleteQuery = @"DELETE FROM [bankers_usr].[Medical_Camp] WHERE id = @id";
            ...
            new SqlParameter("@id", SqlDbType.Int) { Value = idToDelete }
                ...
                ltr_Success.Text = "Medical Camp deleted successfully.";
                div_Success.Visible = true;
