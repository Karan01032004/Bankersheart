<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/bankersheartMaster.Master" AutoEventWireup="true" CodeBehind="View_MedicalCamp.aspx.cs" Inherits="bankersheart.Poweradmin.CSR.MedicalCamp.View_MedicalCamp" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <i class="icon-home"></i>
                <a href="View-MedicalCamp.aspx">Medical Camp</a>
                <i class="fa fa-angle-right"></i>
            </li>
        </ul>
    </div>
    ...
    <div class="actions">
        ...
        <asp:LinkButton ID="Awards_Achivement" runat="server" class="btn sbold white btn-sm" PostBackUrl="~/PowerAdmin/CSR/MedicalCamp/Manage_MedicalCamp.aspx"><i class="fa fa-plus"></i> Add Medical Camp</asp:LinkButton>
    </div>
    <%--  <div class="tools">
                ...
                <div class="portlet-body">
                    <asp:UpdatePanel ID="up1" runat="server">
                        <ContentTemplate>
                                ...
                                <thead>
                                    <tr>
                                       ...
                                       <%--     <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                        ...
                                        <th style="width: 15%">Camp_Date</th>
                            ...
                            <td><%# Eval("Camp_Date", "{0:dd/MM/yyyy}") %></td>
                     <td>
    <img src='<%# ResolveUrl("~/poweradmin/WebFiles/MedicalCampCategory/" + Eval("image")) %>' alt="Image" style="width: 200px; height: 100px;" />
</td>
