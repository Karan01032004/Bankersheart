<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/bankersheartMaster.Master" ValidateRequest="false" AutoEventWireup="true" CodeBehind="Manage_MedicalCamp.aspx.cs" Inherits="bankersheart.Poweradmin.CSR.MedicalCamp.Manage_MedicalCamp" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <i class="icon-home"></i>
                <a href="View_MedicalCamp.aspx">Medical Camps</a>
                <i class="fa fa-angle-right"></i>
            </li>
        </ul>
    </div>
            ...
            <div class="portlet light ">
                <div class="portlet-title">
                    <div class="caption font-red-sunglo">
                        ...
                        <span class="caption-subject font-blue-sharp bold uppercase">Manage Medical Camps</span>
                    </div>
                    <div class="actions">
                        <div class="btn-group">
                            <a class="btn sbold blue-sharp" href="javascript:;" onclick="location.href='View_MedicalCamp.aspx'">Back</a>
    ...
    <div class="form-group">
        <label for="txt_CampDate">Camp Date</label><span style="color: red">*</span>
 ...
 <div class="form-group">
                    ...
                    <br />
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Camp Name</label><span style="color: red">*</span>&nbsp&nbsp[Note: Camp Name which is going to display on medical-camp Page]
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Short Description</label><span style="color: red">*</span>&nbsp&nbsp[Note: Short Description which is going to display on medical-camp Page]
   ...
   <div class="col-md-12">
       <div class="form-group">
           <label>Description</label><span style="color: red">*</span>&nbsp&nbsp[Note: Description which is going to display on medical-camp-details Page]
           <asp:TextBox ID="txt_description" runat="server" CssClass="form-control" ClientIDMode="Static" TextMode="MultiLine" ></asp:TextBox>
                     ...
                     <small style="color: grey">[Maximum 500 Characters allowed]
                        ...
                        <br />
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Medical Camp Category Image</label><span style="color: red">*</span>&nbsp&nbsp[Note: Medical Camp Category Image are going to display on medical-camp.aspx]<br />
...
<asp:Repeater ID="Repeater1" runat="server">
    <ItemTemplate>
        <div style="display: inline-block; height: 150px; width: 200px; border: 2px solid #ccc; padding: 10px; box-sizing: border-box; text-align: center; overflow: hidden;">
            <img src='<%# ResolveUrl("~/poweradmin/WebFiles/MedicalCampCategory/" + Eval("image")) %>' 
                 ...
                 style="width: 100%; height: 100%; object-fit: cover; border-radius: 5px;" />
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Medical Camp Gallery Image</label><span style="color: red">*</span>&nbsp&nbsp[Note: Medical Camp Gallery Images are going to display on medical-camp-details.aspx]<br />
                                    <span class="btn blue-steel btn-outline btn-file">
...
<%--                                        [Recommended Dimension for Mobile - Width : <%=ConfigurationManager.AppSettings["MobileBannerWidth"]%>px - Height : <%=ConfigurationManager.AppSettings["MobileBannerHeight"]%>px].--%>
     ...
     <div class="form-actions text-center">
         ...
         <asp:Button ID="btn_Update" runat="server" Text="Submit" CssClass="btn blue-sharp" ValidationGroup="vgValidate" OnClick="btn_Update_Click" OnClientClick="return confirm('Are you sure want to update Medical Camp details?');" />
         <asp:Button ID="btn_cancel" runat="server" CssClass="btn default" Text="Cancel" OnClick="btn_cancel_Click" />
     </div>
                                    <br /><asp:Repeater ID="rptImages" runat="server">
    <ItemTemplate>
        <div style="display: inline-block; height: 220px; width: 200px; border: 2px solid #ccc; padding: 10px; box-sizing: border-box; text-align: center; overflow: hidden;">
            <img src='<%# ResolveUrl("~/poweradmin/WebFiles/MedicalCamp/" + Eval("image")) %>' 
                 alt="Image" class="img-thumbnail" 
