...
{
    public partial class Manage_CSR_Activity : System.Web.UI.Page
    {
        string TableName = "[bankers_usr].[CSR_Activity]";
        ...
        private void fill_data(string id)
        {
            ...
            DataTable dt = new DAL().GetDataTable("SELECT * FROM " + TableName + " WHERE id='" + id + "' ORDER BY CSR_Activity_Date ASC", CommandType.Text, null);
            if (dt.Rows.Count > 0)
            {
            ...
            DataTable dt1 = new DAL().GetDataTable("SELECT image FROM [bankers_usr].[CSR_Activity_Images] WHERE CSR_Activity_id = '" + id + "' ORDER BY added_date DESC", CommandType.Text, null);
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                txt_CampDate.Text = Convert.ToDateTime(dt.Rows[0]["CSR_Activity_Date"]).ToString("dd-MM-yyyy");
            }
        ...
        protected void RemoveImage(object sender, CommandEventArgs e)
        {
            ...
            string deleteImageQuery = @"DELETE FROM [bankers_usr].[CSR_Activity_Images] WHERE image = @Image AND CSR_Activity_id = @NewsatBankersId";
        ...
        new SqlParameter("@NewsatBankersId", SqlDbType.Int) { Value = Request.QueryString["ID"].ToString() }
            ...
            string filePath = Server.MapPath("~/poweradmin/WebFiles/CSR_Activity/" + imageToRemove);
            ...
            Response.Redirect("Manage_CSR_Activity.aspx?ID=" + Request.QueryString["ID"].ToString() + "&msg=" + Server.UrlEncode(msg));
        }
        ...
        protected void btn_submit_Click(object sender, EventArgs e)
        {
            ...
            foreach (HttpPostedFile uploadedFile in fpbannerimage.PostedFiles)
            {
                ...
                string filepath = "~/poweradmin/WebFiles/CSR_Activity/" + fileName;
            ...
            //    string categoryFilePath = "~/poweradmin/WebFiles/CSR_ActivityCategory/" + categoryFileName;
            ...
            if (Category.HasFile)
            {
                ...
                string categoryFilePathOriginal = "~/poweradmin/WebFiles/CSR_ActivityCategory/" + categoryFileName + categoryFileExtension;
                string categoryFilePathWebP = "~/poweradmin/WebFiles/CSR_ActivityCategory/" + categoryFileName + ".webp";
            ...
            string query = @"INSERT INTO " + TableName + " (Browsertitle,MetaTag,title,titlelink, shortdescription, description, CSR_Activity_Date, added_date, added_ip, image)   VALUES(@Browsertitle,@MetaTag,@Title,@titlelink, @ShortDescription, @Description, @EventsatBankersDate, @AddedDate, @AddedIP, @Image); SELECT SCOPE_IDENTITY(); ";
        ...
        new SqlParameter("@Image", SqlDbType.NVarChar) { Value = categoryImageFileName } // Save category image filename
            ...
            {
                string imageQuery = @"INSERT INTO [bankers_usr].[CSR_Activity_Images] (CSR_Activity_id, image, added_date) 
            ...
            string msg = "CSR Activity added successfully.";
            Response.Redirect("View_CSR_Activity.aspx?msg=" + msg);
        }
            ...
            List<SqlParameter> parameters = new List<SqlParameter>
    {
        ...
        new SqlParameter("@ID", SqlDbType.Int) { Value = id }
            ...
            foreach (string fileName in uploadedFileNames)
            {
                string imageQuery = @"INSERT INTO [bankers_usr].[CSR_Activity_Images] (CSR_Activity_id, image, added_date) VALUES (@MedicalCampId, @Image, @AddedDate)";
                SqlParameter[] imageParameters = {
            ...
            string msg = "CSR_Activity updated successfully.";
            Response.Redirect("view_CSR_Activity.aspx?msg=" + msg);
        }
        protected void btn_cancel_Click(object sender, EventArgs e)
        {
            Response.Redirect("view_CSR_Activity.aspx");
        }
    }
}
