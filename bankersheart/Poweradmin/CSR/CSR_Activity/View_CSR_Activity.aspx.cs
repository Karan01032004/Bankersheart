...
{
    public partial class View_CSR_Activity : System.Web.UI.Page
    {
        ...
        protected void rpt_data_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("Manage_CSR_Activity.aspx?id=" + hdnID.Value);
            }
            ...
            if (e.CommandName == "delete")
            {
                ...
                string deleteImagesQuery = @"DELETE FROM [bankers_usr].[CSR_Activity_Images] WHERE CSR_Activity_id = @Eventsatbankers_id";
            ...
            new SqlParameter("@Eventsatbankers_id", SqlDbType.Int) { Value = idToDelete }
                ...
                string deleteQuery = @"DELETE FROM [bankers_usr].[CSR_Activity] WHERE id = @id";
            ...
            new SqlParameter("@id", SqlDbType.Int) { Value = idToDelete }
                ...
                ltr_Success.Text = "CSR Activity deleted successfully.";
                div_Success.Visible = true;
