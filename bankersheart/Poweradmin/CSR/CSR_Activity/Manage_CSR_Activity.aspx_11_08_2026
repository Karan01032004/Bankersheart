<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/bankersheartMaster.Master" ValidateRequest="false" AutoEventWireup="true" CodeBehind="Manage_CSR_Activity.aspx.cs" Inherits="bankersheart.Poweradmin.CSR.CSR_Activity.Manage_CSR_Activity" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <i class="icon-home"></i>
                <a href="view_CSR_Activity.aspx">CSR Activity</a>
                <i class="fa fa-angle-right"></i>
            </li>
        </ul>
    </div>
            ...
            <div class="portlet light ">
                <div class="portlet-title">
                    <div class="caption font-red-sunglo">
                        ...
                        <span class="caption-subject font-blue-sharp bold uppercase">Manage CSR Activity</span>
                    </div>
                    <div class="actions">
                        <div class="btn-group">
                            <a class="btn sbold blue-sharp" href="javascript:;" onclick="location.href='view_CSR_Activity.aspx'">Back</a>
    ...
    <div class="form-group">
        <label for="txt_CampDate">Activity Date</label><span style="color: red">*</span>
  <div class="input-group">
    ...
    <div class="col-md-12">
     <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Activity Name</label><span style="color: red">*</span>&nbsp&nbsp[Note: Title which is going to display on About_Awards_Achivement Page]
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Short Description</label><span style="color: red">*</span>&nbsp&nbsp[Note: Short Description which is going to display on csr-activity Page]
   ...
   <div class="col-md-12">
       <div class="form-group">
           <label>Description</label><span style="color: red">*</span>&nbsp&nbsp[Note: Description which is going to display on csr-activity-details Page]
...
<%--        <asp:RequiredFieldValidator ID="rvdescription" runat="server" ControlToValidate="txt_description" ErrorMessage="Please fill out this field." ForeColor="Red" Display="Dynamic" ValidationGroup="UserDetails"></asp:RequiredFieldValidator>--%>
                     ...
                     <small style="color: grey">[Maximum 500 Characters allowed]
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>CSR Category Image</label><span style="color: red">*</span>&nbsp&nbsp[Note: CSR Category Image are going to display on csr-activity.aspx]<br />
...
<asp:Repeater ID="Repeater1" runat="server">
    <ItemTemplate>
        <div style="display: inline-block; height: 150px; width: 200px; border: 2px solid #ccc; padding: 10px; box-sizing: border-box; text-align: center; overflow: hidden;">
            <img src='<%# ResolveUrl("~/poweradmin/WebFiles/CSR_ActivityCategory/" + Eval("image")) %>' 
                 ...
                 style="width: 100%; height: 100%; object-fit: cover; border-radius: 5px;" />
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>CSR Gallery Image</label><span style="color: red">*</span>&nbsp&nbsp[Note: CSR Gallery Images are going to display on csr-activity-details.aspx]<br />
                                    <span class="btn blue-steel btn-outline btn-file">
...
<%--                                        [Recommended Dimension for Mobile - Width : <%=ConfigurationManager.AppSettings["MobileBannerWidth"]%>px - Height : <%=ConfigurationManager.AppSettings["MobileBannerHeight"]%>px].--%>
       ...
       <asp:RequiredFieldValidator ID="rvdocument" runat="server" ControlToValidate="fpbannerimage"
        ...
        <asp:RegularExpressionValidator ID="RegularExpressionValidator7" runat="server" ControlToValidate="fpbannerimage"
          ...
          <asp:Button ID="btn_Update" runat="server" Text="Submit" CssClass="btn blue-sharp" ValidationGroup="vgValidate" OnClick="btn_Update_Click" OnClientClick="return confirm('Are you sure want to update CSR_Activity details?');" />
    ...
    <ItemTemplate>
        <div style="display: inline-block; height: 220px; width: 200px; border: 2px solid #ccc; padding: 10px; box-sizing: border-box; text-align: center; overflow: hidden;">
            <img src='<%# ResolveUrl("~/poweradmin/WebFiles/CSR_Activity/" + Eval("image")) %>' alt="Image" class="img-thumbnail" style="width: 100%; height: 150px; object-fit: cover; border-radius: 5px;" />
            <br />
