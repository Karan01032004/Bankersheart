<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/bankersheartMaster.Master" AutoEventWireup="true" CodeBehind="View_CSR_Activity.aspx.cs" Inherits="bankersheart.Poweradmin.CSR.CSR_Activity.View_CSR_Activity" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <i class="icon-home"></i>
                <a href="View-CSR_Activity.aspx">CSR Activity</a>
                <i class="fa fa-angle-right"></i>
            </li>
        </ul>
    </div>
    ...
    <div class="actions">
        ...
        <asp:LinkButton ID="Awards_Achivement" runat="server" class="btn sbold white btn-sm" PostBackUrl="~/PowerAdmin/CSR/CSR_Activity/Manage_CSR_Activity.aspx"><i class="fa fa-plus"></i> Add CSR Activity</asp:LinkButton>
    </div>
    <%--  <div class="tools">
                        ...
                        <ContentTemplate>
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 15%">Activity_Date</th>
                            ...
                            <td><%# Eval("CSR_Activity_Date", "{0:dd/MM/yyyy}") %></td>
                                                 <td>
     <img src='<%# ResolveUrl("~/poweradmin/WebFiles/CSR_ActivityCategory/" + Eval("image")) %>' alt="Image" style="width: 200px; height: 100px;" />
     </td>
                                                <td>
