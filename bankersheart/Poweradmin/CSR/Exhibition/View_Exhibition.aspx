<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/bankersheartMaster.Master" AutoEventWireup="true" CodeBehind="View_Exhibition.aspx.cs" Inherits="bankersheart.Poweradmin.CSR.Exhibition.View_Exhibition" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <i class="icon-home"></i>
                <a href="View-Exhibition.aspx">Exhibition</a>
                <i class="fa fa-angle-right"></i>
            </li>
        </ul>
    </div>
    ...
    <div class="actions">
        ...
        <asp:LinkButton ID="Awards_Achivement" runat="server" class="btn sbold white btn-sm" PostBackUrl="~/PowerAdmin/CSR/Exhibition/Manage_Exhibition.aspx"><i class="fa fa-plus"></i> Add Exhibition</asp:LinkButton>
    </div>
    <%--  <div class="tools">
                        ...
                        <ContentTemplate>
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 15%">Exhibition_Date</th>
                            ...
                            <td><%# Eval("Exhibition_Date", "{0:dd/MM/yyyy}") %></td>
                                                <td>
                                                    <img src='<%# ResolveUrl("~/poweradmin/WebFiles/ExhibitionCategory/" + Eval("image")) %>' alt="Image" style="width: 200px; height: 100px;" />
                                                    </td>
                                                <td>
