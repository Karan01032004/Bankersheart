<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/bankersheartMaster.Master" AutoEventWireup="true" CodeBehind="View_YouTubeVideo.aspx.cs" Inherits="bankersheart.Poweradmin.Media.YouTubeVideo.View_YouTubeVideo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="actions">
        ...
        <asp:LinkButton ID="Awards_Achivement" runat="server" class="btn sbold white btn-sm" PostBackUrl="~/PowerAdmin/Media/YouTubeVideo/Manage_YouTubeVideo.aspx"><i class="fa fa-plus"></i> Add YouTube Video</asp:LinkButton>
    </div>
    <%--  <div class="tools">
                                    ...
                                    <asp:Repeater ID="rpt_data" runat="server" OnItemCommand="rpt_data_ItemCommand" OnItemDataBound="rpt_data_ItemDataBound">
                                        <ItemTemplate>
                                            <tr class="odd gradeX">
                                                ...
                                                <td>
<iframe width="200" height="150" src='<%# GetYouTubeIframeSrc(Eval("YouTubeVideo")) %>' frameborder="0" allowfullscreen></iframe>
