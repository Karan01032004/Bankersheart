<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/bankersheartMaster.Master" ValidateRequest="false" AutoEventWireup="true" CodeBehind="Manage_NewsatBankers.aspx.cs" Inherits="bankersheart.Poweradmin.Media.NewsatBankers.Manage_NewsatBankers" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <i class="icon-home"></i>
                <a href="view_NewsatBankers.aspx">NewsatBankers</a>
                <i class="fa fa-angle-right"></i>
            </li>
        </ul>
    </div>
            ...
            <div class="portlet light ">
                <div class="portlet-title">
                    <div class="caption font-red-sunglo">
                        ...
                        <span class="caption-subject font-blue-sharp bold uppercase">Manage NewsatBankers</span>
                    </div>
                    <div class="actions">
                        <div class="btn-group">
                            <a class="btn sbold blue-sharp" href="javascript:;" onclick="location.href='view_NewsatBankers.aspx'">Back</a>
    ...
    <div class="form-group">
        <label for="txt_CampDate">News Date</label><span style="color: red">*</span>
  <div class="input-group">
                  ...
                  <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txt_CampDate" ErrorMessage="Please fill out this field." ForeColor="Red" Display="Dynamic" ValidationGroup="UserDetails"></asp:RequiredFieldValidator>
    ...
    <div class="col-md-12">
     <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Title</label><span style="color: red">*</span>&nbsp&nbsp[Note: Title which is going to display on news-at-bankers Page]
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Short Description</label><span style="color: red">*</span>&nbsp&nbsp[Note: Short Description which is going to display on news-at-bankers Page]
   ...
   <div class="col-md-12">
       <div class="form-group">
           <label>Description</label><span style="color: red">*</span>&nbsp&nbsp[Note: Description which is going to display on news-at-bankers-details Page]
...
<%--        <asp:RequiredFieldValidator ID="rvdescription" runat="server" ControlToValidate="txt_description" ErrorMessage="Please fill out this field." ForeColor="Red" Display="Dynamic" ValidationGroup="UserDetails"></asp:RequiredFieldValidator>--%>
                     ...
                     <small style="color: grey">[Maximum 500 Characters allowed]
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>News Category Image</label><span style="color: red">*</span>&nbsp&nbsp[Note: News Category Image are going to display on news-at-bankers.aspx]<br />
...
<asp:Repeater ID="Repeater1" runat="server">
    <ItemTemplate>
        <div style="display: inline-block; height: 150px; width: 200px; border: 2px solid #ccc; padding: 10px; box-sizing: border-box; text-align: center; overflow: hidden;">
            <img src='<%# ResolveUrl("~/poweradmin/WebFiles/NewsatBankersCategory/" + Eval("image")) %>' 
                 ...
                 style="width: 100%; height: 100%; object-fit: cover; border-radius: 5px;" />
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>News Gallery Image</label><span style="color: red">*</span>&nbsp&nbsp[Note: News Gallery Image is going to display on news-at-bankers-details.aspx]<br />
                                    <span class="btn blue-steel btn-outline btn-file">
...
<%--                                        [Recommended Dimension for Mobile - Width : <%=ConfigurationManager.AppSettings["MobileBannerWidth"]%>px - Height : <%=ConfigurationManager.AppSettings["MobileBannerHeight"]%>px].--%>
       ...
       <asp:Button ID="btn_Update" runat="server" Text="Submit" CssClass="btn blue-sharp" ValidationGroup="vgValidate" OnClick="btn_Update_Click" OnClientClick="return confirm('Are you sure want to update News at Bankers details?');" />
...
<asp:Repeater ID="rptImages" runat="server">
    <ItemTemplate>
        <div style="display: inline-block; height: 220px; width: 200px; border: 2px solid #ccc; padding: 10px; box-sizing: border-box; text-align: center; overflow: hidden;">
            <img src='<%# ResolveUrl("~/poweradmin/WebFiles/NewsatBankers/" + Eval("image")) %>' alt="Image" class="img-thumbnail" style="width: 100%; height: 150px; object-fit: cover; border-radius: 5px;" />
            <br />
