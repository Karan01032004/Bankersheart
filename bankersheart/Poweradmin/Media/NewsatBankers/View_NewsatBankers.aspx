<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/bankersheartMaster.Master" AutoEventWireup="true" CodeBehind="View_NewsatBankers.aspx.cs" Inherits="bankersheart.Poweradmin.Media.NewsatBankers.View_NewsatBankers" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <i class="icon-home"></i>
                <a href="View_NewsatBankers.aspx">News at Bankers</a>
                <i class="fa fa-angle-right"></i>
            </li>
        </ul>
    </div>
    ...
    <div class="actions">
        ...
        <asp:LinkButton ID="Awards_Achivement" runat="server" class="btn sbold white btn-sm" PostBackUrl="~/PowerAdmin/Media/NewsatBankers/Manage_NewsatBankers.aspx"><i class="fa fa-plus"></i> Add News at Bankers</asp:LinkButton>
    </div>
    <%--  <div class="tools">
                                    ...
                                    <asp:Repeater ID="rpt_data" runat="server" OnItemCommand="rpt_data_ItemCommand" OnItemDataBound="rpt_data_ItemDataBound">
                                        <ItemTemplate>
                                            <tr class="odd gradeX">
                                               ...
                                               <%-- <td>
                            <img src='<%# ResolveUrl("~/Poweradmin/Webfiles/NewsatBankers/" + Eval("image")) %>' width="200" />

                                                   
                                                </td>--%>
                                                 <asp:HiddenField ID="hdnID" runat="server" Value='<%# Eval("id") %>' />
                            <td><%# Eval("NewsatBankers_Date", "{0:dd/MM/yyyy}") %></td>
                                                                                                                                            <td>
<img src='<%# ResolveUrl("~/poweradmin/WebFiles/NewsatBankersCategory/" + Eval("image")) %>' alt="Image" style="width: 200px; height: 100px;" />
</td>
                                                <td>
