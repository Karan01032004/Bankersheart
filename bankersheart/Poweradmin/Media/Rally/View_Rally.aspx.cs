...
{
    public partial class View_Rally : System.Web.UI.Page
    {
        ...
        protected void rpt_data_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("Manage_Rally.aspx?id=" + hdnID.Value);
            }
            ...
            if (e.CommandName == "delete")
            {
                ...
                string deleteImagesQuery = @"DELETE FROM [bankers_usr].[Rally_Images] WHERE Rally_id = @Eventsatbankers_id";
            ...
            new SqlParameter("@Eventsatbankers_id", SqlDbType.Int) { Value = idToDelete }
                ...
                string deleteQuery = @"DELETE FROM [bankers_usr].[Rally]  WHERE id = @id";
            ...
            new SqlParameter("@id", SqlDbType.Int) { Value = idToDelete }
                ...
                ltr_Success.Text = "Rally deleted successfully.";
                div_Success.Visible = true;
