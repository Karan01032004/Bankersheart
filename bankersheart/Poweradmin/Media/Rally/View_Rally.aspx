<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/bankersheartMaster.Master" AutoEventWireup="true" CodeBehind="View_Rally.aspx.cs" Inherits="bankersheart.Poweradmin.Media.Rally.View_Rally" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="actions">
        ...
        <asp:LinkButton ID="Awards_Achivement" runat="server" class="btn sbold white btn-sm" PostBackUrl="~/PowerAdmin/Media/Rally/Manage_Rally.aspx"><i class="fa fa-plus"></i> Add Rally</asp:LinkButton>
    </div>
    <%--  <div class="tools">
...
<%--                                        <th style="width: 15%">Image</th>--%>
                                        ...
                                        <th style="width: 15%">Rally Date</th>
                                ...
                                <tbody>
                                    <asp:Repeater ID="rpt_data" runat="server" OnItemCommand="rpt_data_ItemCommand" OnItemDataBound="rpt_data_ItemDataBound">
                                       ...
                                       <%--         <td>
                                <img src='<%# ResolveUrl("~/Poweradmin/Webfiles/Rally/" + Eval("image")) %>' width="200" />
    </td>--%>
                                                    <asp:HiddenField ID="hdnID" runat="server" Value='<%# Eval("id") %>' />
                                            

                            <td><%# Eval("Rally_Date", "{0:dd/MM/yyyy}") %></td>
                                                  <td>
                                <img src='<%# ResolveUrl("~/Poweradmin/Webfiles/RallyCategory/" + Eval("image")) %>' width="200" />
    </td>
                                                <td>
