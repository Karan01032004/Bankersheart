<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/bankersheartMaster.Master" AutoEventWireup="true" CodeBehind="View_Conference.aspx.cs" Inherits="bankersheart.Poweradmin.Media.Conference.View_Conference" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="actions">
        ...
        <asp:LinkButton ID="Awards_Achivement" runat="server" class="btn sbold white btn-sm" PostBackUrl="~/PowerAdmin/Media/Conference/Manage_Conference.aspx"><i class="fa fa-plus"></i> Add Conference</asp:LinkButton>
    </div>
    <%--  <div class="tools">
...
<%--                                        <th style="width: 15%">Image</th>--%>
                                        <th style="width: 15%">Conference_Date</th>
                                        <th style="width: 15%">Category Images</th>
          ...
          <%--                                      <td>
                                <img src='<%# ResolveUrl("~/Poweradmin/Webfiles/Conference/" + Eval("image")) %>' width="200" />
   </td>--%>
                                                    <asp:HiddenField ID="hdnID" runat="server" Value='<%# Eval("id") %>' />
                                             

                            <td><%# Eval("Conference_Date", "{0:dd/MM/yyyy}") %></td>
                                                
                                          <td>
                                <img src='<%# ResolveUrl("~/Poweradmin/Webfiles/ConferenceCategory/" + Eval("image")) %>' width="200" />
   </td>
                                                <td>
