...
namespace bankersheart.Poweradmin.Media.Conference
{
    public partial class View_Conference : System.Web.UI.Page
    {
        ...
        protected void rpt_data_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("Manage_Conference.aspx?id=" + hdnID.Value);
            }
            ...
            if (e.CommandName == "delete")
            {
                ...
                string deleteImagesQuery = @"DELETE FROM [bankers_usr].[Conference_Images] WHERE Conference_id = @Eventsatbankers_id";
            ...
            new SqlParameter("@Eventsatbankers_id", SqlDbType.Int) { Value = idToDelete }
                ...
                string deleteQuery = @"DELETE FROM [bankers_usr].[Conference] WHERE id = @id";
            ...
            new SqlParameter("@id", SqlDbType.Int) { Value = idToDelete }
                ...
                ltr_Success.Text = "Conference deleted successfully.";
                div_Success.Visible = true;
