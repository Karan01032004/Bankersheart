<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/bankersheartMaster.Master" AutoEventWireup="true" CodeBehind="View_Downloads.aspx.cs" Inherits="bankersheart.Poweradmin.Media.Downloads.View_Downloads" %>
            ...
            <div class="portlet box green">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        ...
                        <asp:LinkButton ID="Awards_Achivement" runat="server" class="btn sbold white btn-sm" PostBackUrl="~/Poweradmin/Media/Downloads/Manage_Downloads.aspx"><i class="fa fa-plus"></i> Add Downloads</asp:LinkButton>
                    </div>
                    <%--  <div class="tools">
                        ...
                        <thead>
                            <tr>
                               ...
                               <%-- <th style="width: 10%; text-align: center;" data-sortable="false">
                                ...
                                <th style="width: 20%">Thumb Image</th>
                                ...
                                <ItemTemplate>
                                    <tr>
                                     ...
                                     <%--   <td style="text-align: center;">
                                        ...
                                        <td><%# Eval("title") %></td>
                           <td >    <img src='<%# ResolveUrl("~/Poweradmin/Webfiles/Downloads/" + Eval("image")) %>' width="200" /></td>
                                      
<td>
    <a href="<%= ResolveUrl("~/PowerAdmin/webfiles/Downloads/") %><%# Eval("PDF") %>" target="_blank">
       <%# Eval("PDF") %> 
    </a>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#li_Downloads').addClass("start active");
            $('#li_Downloads').addClass("open");
        });
    </script>
    <script>
        $(document).ready(function () {
