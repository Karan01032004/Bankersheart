<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/bankersheartMaster.Master" AutoEventWireup="true" CodeBehind="View_InfrastructureName.aspx.cs" Inherits="bankersheart.Poweradmin.Media.Infrastructure.View_InfrastructureName" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="actions">
        ...
        <asp:LinkButton ID="Awards_Achivement" runat="server" class="btn sbold white btn-sm" PostBackUrl="~/PowerAdmin/Media/Infrastructure/Manage_InfrastructureName.aspx"><i class="fa fa-plus"></i> Add Infrastructure Name</asp:LinkButton>
    </div>
    <%--  <div class="tools">
