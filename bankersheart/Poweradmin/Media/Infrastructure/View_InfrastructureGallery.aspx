<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/bankersheartMaster.Master" AutoEventWireup="true" CodeBehind="View_InfrastructureGallery.aspx.cs" Inherits="bankersheart.Poweradmin.Media.Infrastructure.View_InfrastructureGallery" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="actions">
        ...
        <asp:LinkButton ID="Awards_Achivement" runat="server" class="btn sbold white btn-sm" PostBackUrl="~/PowerAdmin/Media/Infrastructure/Manage_InfrastructureGalleryaspx.aspx"><i class="fa fa-plus"></i> Add Infrastructure Gallery</asp:LinkButton>
    </div>
    <%--  <div class="tools">
                        ...
                        <ContentTemplate>
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 20%">Infrastructure Name</th>
                                    ...
                                    <asp:Repeater ID="rpt_data" runat="server" OnItemCommand="rpt_data_ItemCommand" OnItemDataBound="rpt_data_ItemDataBound">
                                        <ItemTemplate>
                                            <tr class="odd gradeX">
                                                ...
                                                <td><%# Eval("InfrastructureName") %></td>
                                                <td><%# Eval("title") %></td>
                                      
                                                <td>
                                <img src='<%# ResolveUrl("~/Poweradmin/Webfiles/InfrastructureGallery/" + Eval("image")) %>' width="200" />
