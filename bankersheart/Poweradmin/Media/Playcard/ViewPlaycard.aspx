<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/bankersheartMaster.Master" AutoEventWireup="true" CodeBehind="ViewPlaycard.aspx.cs" Inherits="bankersheart.Poweradmin.Media.Playcard.ViewPlaycard" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <i class="icon-home"></i>
                <a href="View_Playcard.aspx">Play Cards</a>
                <i class="fa fa-angle-right"></i>
            </li>
        </ul>
    </div>
...
<%--       <asp:LinkButton ID="Awards_Achivement" runat="server" class="btn sbold white btn-sm" PostBackUrl="~/PowerAdmin/Media/Playcard/Manage_Playcard.aspx"><i class="fa fa-plus"></i> Add Play Cards</asp:LinkButton>--%>
    </div>
    <%--  <div class="tools">
                                    ...
                                    <asp:Repeater ID="rpt_data" runat="server" OnItemCommand="rpt_data_ItemCommand" OnItemDataBound="rpt_data_ItemDataBound">
                                        <ItemTemplate>
                                            <tr class="odd gradeX">
                                                ...
                                                <td>
                                <img src='<%# ResolveUrl("~/Poweradmin/Webfiles/PlayCardCategory/" + Eval("image")) %>' width="200" />
