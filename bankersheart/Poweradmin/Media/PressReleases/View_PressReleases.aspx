<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/bankersheartMaster.Master" AutoEventWireup="true" CodeBehind="View_PressReleases.aspx.cs" Inherits="bankersheart.Poweradmin.Media.PressReleases.View_PressReleases" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <i class="icon-home"></i>
                <a href="View-PressReleases.aspx">Press Releases</a>
                <i class="fa fa-angle-right"></i>
            </li>
        </ul>
    </div>
    ...
    <div class="actions">
        ...
        <asp:LinkButton ID="Awards_Achivement" runat="server" class="btn sbold white btn-sm" PostBackUrl="~/PowerAdmin/Media/PressReleases/Manage_PressReleases.aspx"><i class="fa fa-plus"></i> Add Press Releases</asp:LinkButton>
    </div>
    <%--  <div class="tools">
                        ...
                        <ContentTemplate>
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 15%">PressReleases_Date</th>
                                    ...
                                    <asp:Repeater ID="rpt_data" runat="server" OnItemCommand="rpt_data_ItemCommand" OnItemDataBound="rpt_data_ItemDataBound">
                                        <ItemTemplate>
                                            <tr class="odd gradeX">
                                                ...
                                                <td>
                                <img src='<%# ResolveUrl("~/Poweradmin/Webfiles/PressReleases/" + Eval("image")) %>' width="200" />

                                                    <asp:HiddenField ID="hdnID" runat="server" Value='<%# Eval("id") %>' />
                                                </td>

                            <td><%# Eval("PressReleases_Date", "{0:dd/MM/yyyy}") %></td>
