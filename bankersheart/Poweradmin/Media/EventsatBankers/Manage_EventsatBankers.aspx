...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <i class="icon-home"></i>
                <a href="view_EventsatBankers.aspx">Events at Bankers</a>
                <i class="fa fa-angle-right"></i>
            </li>
        </ul>
    </div>
            ...
            <div class="portlet light ">
                <div class="portlet-title">
                    <div class="caption font-red-sunglo">
                        ...
                        <span class="caption-subject font-blue-sharp bold uppercase">Manage Events at Bankers</span>
                    </div>
                    <div class="actions">
                        <div class="btn-group">
                            <a class="btn sbold blue-sharp" href="javascript:;" onclick="location.href='view_EventsatBankers.aspx'">Back</a>
    ...
    <div class="form-group">
        <label for="txt_CampDate">Events at Bankers Date</label><span style="color: red">*</span>
    ...
    <div class="col-md-12">
     <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Events at Bankers Name</label><span style="color: red">*</span>&nbsp&nbsp[Note: Event Name which is going to display on events-at-bankers Page]
...
<%--        <asp:RequiredFieldValidator ID="rvdescription" runat="server" ControlToValidate="txt_description" ErrorMessage="Please fill out this field." ForeColor="Red" Display="Dynamic" ValidationGroup="UserDetails"></asp:RequiredFieldValidator>--%>
                     ...
                     <small style="color: grey">[Maximum 500 Characters allowed]
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Event Category Image</label><span style="color: red">*</span>&nbsp&nbsp[Note: Event Category Image are going to display on events-at-bankers.aspx]<br />
...
<asp:Repeater ID="Repeater1" runat="server">
    <ItemTemplate>
        <div style="display: inline-block; height: 150px; width: 200px; border: 2px solid #ccc; padding: 10px; box-sizing: border-box; text-align: center; overflow: hidden;">
            <img src='<%# ResolveUrl("~/poweradmin/WebFiles/EventsatBankersCategory/" + Eval("image")) %>' 
                 ...
                 style="width: 100%; height: 100%; object-fit: cover; border-radius: 5px;" />
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Events Image</label><span style="color: red">*</span>&nbsp&nbsp[Note: Events Gallery Images  are going to display on events-at-bankers-details.aspx]<br />
                                    <span class="btn blue-steel btn-outline btn-file">
  ...
  <asp:Repeater ID="rptImages" runat="server">
    <ItemTemplate>
        <div style="display: inline-block; height: 220px; width: 200px; border: 2px solid #ccc; padding: 10px; box-sizing: border-box; text-align: center; overflow: hidden;">
            <img src='<%# ResolveUrl("~/poweradmin/WebFiles/EventsatBankers/" + Eval("image")) %>' alt="Image" class="img-thumbnail" style="width: 100%; height: 150px; object-fit: cover; border-radius: 5px;" />
            <br />
