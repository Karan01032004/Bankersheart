...
{
    public partial class View_EventsatBankers : System.Web.UI.Page
    {
        ...
        protected void rpt_data_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("Manage_EventsatBankers.aspx?id=" + hdnID.Value);
            }
            ...
            if (e.CommandName == "delete")
            {
                ...
                string deleteImagesQuery = @"DELETE FROM [bankers_usr].[EventsatBankers_Images] WHERE Eventsatbankers_id = @Eventsatbankers_id";
            ...
            new SqlParameter("@Eventsatbankers_id", SqlDbType.Int) { Value = idToDelete }
                ...
                string deleteQuery = @"DELETE FROM [bankers_usr].[EventsatBankers] WHERE id = @id";
            ...
            new SqlParameter("@id", SqlDbType.Int) { Value = idToDelete }
                ...
                ltr_Success.Text = "Events at Bankers deleted successfully.";
                div_Success.Visible = true;
