<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/bankersheartMaster.Master" AutoEventWireup="true" CodeBehind="View_EventsatBankers.aspx.cs" Inherits="bankersheart.Poweradmin.Media.EventsatBankers.View_EventsatBankers" %>
                ...
                <div class="portlet-body">
                    <asp:UpdatePanel ID="up1" runat="server">
                        <ContentTemplate>
                            ...
                            <td><%# Eval("EventsatBankers_Date", "{0:dd/MM/yyyy}") %></td>
                                                                                            <td>
<img src='<%# ResolveUrl("~/poweradmin/WebFiles/EventsatBankersCategory/" + Eval("image")) %>' alt="Image" style="width: 200px; height: 100px;" />
</td>
                                                <td>
