<%@ Page Title="" Language="C#" MasterPageFile="~/Poweradmin/bankersheartMaster.Master" AutoEventWireup="true" CodeBehind="View_Lectures.aspx.cs" Inherits="bankersheart.Poweradmin.Media.Lectures.View_Lectures" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="actions">
        ...
        <asp:LinkButton ID="Awards_Achivement" runat="server" class="btn sbold white btn-sm" PostBackUrl="~/PowerAdmin/Media/Lectures/Manage_Lectures.aspx"><i class="fa fa-plus"></i> Add Lectures</asp:LinkButton>
    </div>
    <%--  <div class="tools">
...
<%--                                        <th style="width: 15%">Image</th>--%>
                                        <th style="width: 15%">Lectures_Date</th>
                            ...
                            <td><%# Eval("Lectures_Date", "{0:dd/MM/yyyy}") %></td>
                                                
                                              <td>
                                <img src='<%# ResolveUrl("~/Poweradmin/Webfiles/LecturesCategory/" + Eval("image")) %>' width="200" />
                                                       </td>
                                                <td>
