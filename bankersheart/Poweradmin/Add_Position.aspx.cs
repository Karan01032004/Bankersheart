...
{
    public partial class Add_Position : System.Web.UI.Page
    {
        string TableName = "[bankers_usr].[CarrerPosition]";
        ...
        private void fill_data(string id)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                txt_Title.Text = dt.Rows[0]["Position"].ToString();
        ...
        protected void btn_submit_Click(object sender, EventArgs e)
        {
                ...
                string query = @"INSERT INTO " + TableName + " (Position, added_date, added_ip)  VALUES(@Title, @AddedDate, @AddedIP)";
            ...
            string msg = "Position added successfully.";
            Response.Redirect("View_Position.aspx?msg=" + msg);
        ...
        protected void btn_Update_Click(object sender, EventArgs e)
        {
            ...
            string query = @"UPDATE " + TableName + " SET Position = @Title,  modified_date = @ModifiedDate, modified_ip = @ModifiedIP";
        ...
        new SqlParameter("@ID", SqlDbType.Int) { Value = id }
            ...
            string msg = "Position Name updated successfully.";
            Response.Redirect("View_Position.aspx?msg=" + msg);
        }
        ...
        {
            Response.Redirect("View_Position.aspx");
        }
    }
}