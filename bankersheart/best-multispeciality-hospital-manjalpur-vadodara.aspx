<%@ Page Title="Top Multispeciality Hospital in Vadodara | Multispeciality Hospital" Language="C#" MasterPageFile="~/bankers.Master" AutoEventWireup="true" CodeBehind="best-multispeciality-hospital-manjalpur-vadodara.aspx.cs" Inherits="bankersheart.bankers_superspeciality_hospitals" %>
                ...
                <div class="col-lg-6 contact-details mt-lg-0 mt-5 px-0">
                    ...
                    <div class="row align-items-center px-sm-0 px-2 pt-3">
                        ...
                        <div class="col-10 ps-0">
                            <p class="mb-0">
                                Opp. Mahalaxmi Party Plot, Tulsidham-GIDC Road<br />
                    ...
                    <div class="row align-items-center px-sm-0 px-2 pt-3">
                        ...
                        <div class="col-10 ps-0">
                            <a href="tel:+91 265 2602602">+91 265 2602602</a><br class="d-md-none d-inline-block" />
                            <%--                            <a href="tel:+91 63549 13343" class="ps-md-3">+91 63549 13343</a><br />--%>
            ...
            document.querySelectorAll(".accordion-button").forEach(button => {
                button.addEventListener("click", function () {
                    setTimeout(() => {
                        ...
                        let offset = heading.getBoundingClientRect().top + window.scrollY - 180;
                        window.scrollTo({ top: offset, behavior: "smooth" });
                    }, 300);
                });
            });
